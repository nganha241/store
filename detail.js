...
const relatedBox = document.getElementsByClassName("related-box");
const relatedPre = document.querySelector(".related-control.related-pre");
const relatedNext = document.querySelector(".related-control.related-next");

relatedNext.addEventListener("click", () => {
  relatedCard.append(relatedBox[0]);
});

relatedPre.addEventListener("click", () => {
  relatedCard.prepend(relatedBox[relatedBox.length - 1]);
});
